...
public class TbAceSubScenarios implements java.io.Serializable {
    ...
    public TbAceSubScenarios() {
    }

    public TbAceSubScenarios(int fkTbAceProSeq, String bestLoaRange, Date createDate, Date updateDate) {
