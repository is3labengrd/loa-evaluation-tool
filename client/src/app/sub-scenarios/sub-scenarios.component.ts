...
export class SubScenariosComponent implements OnInit {
  ...
  scenario1: {resourceName: any, loaPhysical: number, loaCognitive: number, processTime: number,
              ...
              assemblyCostsPerPiece: number, assemblyCostsTotal: number } = {resourceName: null, loaPhysical: null, loaCognitive: null, processTime: null,
   ...
   scenario2: {resourceName: any, loaPhysical: number, loaCognitive: number, processTime: number,
               numberShiftsPerDay: number, hoursPerShift: number, workingDaysPerYear: number,
               hoursPerYear: number, numProducedPiecesHour: number, numProducedPiecesYear: number,
               propWageCostsPerHour: number, numberOperationsPerMachine: number, ratioOfParticipPerHour: number,
               labourCosts: number, electrConsumption: number, electrConsumptionStandby: number,
   ...
   scenario3: {resourceName: any, loaPhysical: number, loaCognitive: number, processTime: number,
               numberShiftsPerDay: number, hoursPerShift: number, workingDaysPerYear: number,
               hoursPerYear: number, numProducedPiecesHour: number, numProducedPiecesYear: number,
               propWageCostsPerHour: number, numberOperationsPerMachine: number, ratioOfParticipPerHour: number,
               labourCosts: number, electrConsumption: number, electrConsumptionStandby: number,
