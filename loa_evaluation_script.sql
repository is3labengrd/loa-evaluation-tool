...
-- Schema loa_evaluation_tool
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `loa_evaluation_tool` DEFAULT CHARACTER SET utf8 ;
...
CREATE TABLE IF NOT EXISTS `loa_evaluation_tool`.`TB_ACE_RES` (
  ...
  `UDPATE_DATE` DATETIME NOT NULL,
  `TB_ACE_SUB_SCEN_RES_PK_TB_ID` INT NOT NULL,
  PRIMARY KEY (`PK_TB_ID`, `TB_ACE_SUB_SCEN_RES_PK_TB_ID`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `loa_evaluation_tool`.`TB_ACE_PRO_SPEC` (
  `PK_TB_ID` INT NOT NULL AUTO_INCREMENT,
  `FK_TB_ACE_SUB_PRO_LEV` INT NOT NULL,
  `N_SHIPTS_DAY` INT(11) NOT NULL,
  `HOURS_SHIFT` INT(11) NOT NULL,
  `WORKING_DAYS_YEAR` INT(11) NOT NULL,
  `CREATE_DATE` DATETIME NOT NULL,
  `UPDATE_DATE` DATETIME NOT NULL,
  `PROP_WAGE_COSTS_PER_HOUR` INT(11) NOT NULL,
  PRIMARY KEY (`PK_TB_ID`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `loa_evaluation_tool`.`TB_ACE_SUB_SCEN_RES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `loa_evaluation_tool`.`TB_ACE_SUB_SCEN_RES` ;

CREATE TABLE IF NOT EXISTS `loa_evaluation_tool`.`TB_ACE_SUB_SCEN_RES` (
  `PK_TB_ID` INT NOT NULL AUTO_INCREMENT,
  `FK_TB_ACE_SUB_SCENARIOS` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `loa_evaluation_tool`.`TB_ACE_SCEN_SUB_SCEN`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `loa_evaluation_tool`.`TB_ACE_SCEN_SUB_SCEN` ;

CREATE TABLE IF NOT EXISTS `loa_evaluation_tool`.`TB_ACE_SCEN_SUB_SCEN` (
  `PK_TB_ID` INT NOT NULL AUTO_INCREMENT,
  `FK_TB_ACE_SCENARIOS` INT NOT NULL,
  `FK_TB_ACE_SUB_SCEN_RES` INT NOT NULL,
  `OPTION_COST` DOUBLE NULL,
  `TOTAL_COST` DOUBLE NULL,
  `COST_PER_PIECE` DOUBLE NULL,
  `PHYSICAL_LOA` INT NULL,
  `COGNITIVE_LOA` INT NULL,
