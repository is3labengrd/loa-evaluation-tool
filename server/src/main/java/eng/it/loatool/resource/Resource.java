...
@Entity @Table(name = "TB_ACE_RES", catalog = "loa_evaluation_tool"
    ...
    public Resource(TbAceResId id, int fkTbAceSubProLev, String name, int loaPhysical, int loaCognitive, double lcNOperMachine, double mcAMaintCosts, float mcAMaintCostsPerc, String rcInstSurface, double rcCostsMMonth, double idMacPurhValue, double idMacSalesValue, int idEcoUsefullLife, float icInterRate, int ecAEleConsumFun, int ecAEleConsumSb, Date createDate, double ecElePrice, Date udpateDate) {
        this.id = id;
    ...
    @AttributeOverrides({ @AttributeOverride(name = "pkTbId", column = @Column(name = "PK_TB_ID", nullable = false)), @AttributeOverride(name = "tbAceSubScenResPkTbId", column = @Column(name = "TB_ACE_SUB_SCEN_RES_PK_TB_ID", nullable = false)) }) public TbAceResId getId() {
        return this.id;
    }
