...
/**
 * This is actually a PhysicalCriteriaMatrix,
 * but, for some reason, I have been informed of this near the end of the Project.
 * So the name stays the same, too much hassle to change.
 */
@Entity @Table(name = "TB_ACE_LOA_CRI_MAT", catalog = "loa_evaluation_tool"
    ...
    public CriteriaMatrix(Date createDate, Date updateDate) {
    ...
    public void setDsStable(Integer dsStable) {
        this.dsStable = dsStable;
    }
    ...
    @Column(name = "EC_A_ELE_CONSUM_FUN") public Integer getEcAEleConsumFun() {
