 ...
 */
@Entity @Table(name = "TB_ACE_SCEN_SUB_SCEN", catalog = "loa_evaluation_tool"
    ...
    public ScenarioSubScenarios(int fkTbAceScenarios, int fkTbAceSubScenRes, Double optionCost, Double totalCost, Double costPerPiece, Integer physicalLoa, Integer cognitiveLoa, Integer totalProcessTime, Integer hoursYear, Double labourCost, Double maintCost, Double annualSpaceCost, Double inputedDepreciation, Double accruedInterestCost, Double energyCost, Double macHourlyRate, Double macCost, Date createDate, Date udpateDate) {
        this.fkTbAceScenarios = fkTbAceScenarios;
        this.fkTbAceSubScenRes = fkTbAceSubScenRes;
    ...
    @Column(name = "FK_TB_ACE_SCENARIOS", nullable = false) public int getFkTbAceScenarios() {
    ...
    @Column(name = "FK_TB_ACE_SUB_SCEN_RES", nullable = false) public int getFkTbAceSubScenRes() {
    ...
    @Column(name = "PHYSICAL_LOA") public Integer getPhysicalLoa() {
    ...
    @Column(name = "COGNITIVE_LOA") public Integer getCognitiveLoa() {
    ...
    @Column(name = "MAC_HOURLY_RATE", precision = 22, scale = 0) public Double getMacHourlyRate() {
