...
public class SubScenarioResources implements java.io.Serializable {
    ...
    public SubScenarioResources(
        int fkTbAceSubScenarios, int scenarioNumber, int processTime, Date createDate,
        Date updateDate
    ) {
    ...
    public SubScenarioResources(
        int fkTbAceSubScenarios, int scenarioNumber, int processTime, Double assemblyCostPerPiece,
